...
内部类:
        ...
        静态内部类:
            通常称为嵌套类. 在创建静态内部类的实例时, 不依赖外部类的对象, 不能访问外部类的非静态成员变量和方法.
        ...
        方法内部类:
             ...
             方法内部类只能在定义该类的方法内实例化和使用.
             方法内部类对象不能使用该内部类中的非final局部变量. 
        ...
        匿名内部类:
            ...
            参数式:
                ...
                public static void print1(Outer outer) {
                    outer.print();
                }
